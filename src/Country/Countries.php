...
final class Countries
{
    ...
    /** @var array<int, Country>|Country[]|null */
    public static ?array $countries = null;

    /**
     * @return array<int, Country>|Country[]
     */
    public static function List(): array
    {
        if (self::$countries === null) {
            self::$countries = [
                ...
                new Country('Bolivia', 'BO', 'BOL', '068'),
                ...
                new Country('Congo (Congo-Brazzaville)', 'CG', 'COG', '178'),
                ...
                new Country('Virgin Islands (British)', 'VI', 'VIR', '092'),
                new Country('Virgin Islands (U.S.)', 'VN', 'VNM', '850'),
    ...
    public static function FindByAlpha2(string $alpha2): ?Country
    {
        return array_find(self::List(), fn ($country) => $country->alpha2 === strtoupper($alpha2));
    }

    public static function FindByAlpha3(string $alpha3): ?Country
    {
        return array_find(self::List(), fn ($country) => $country->alpha3 === strtoupper($alpha3));
    }

    public static function FindByName(string $name): ?Country
    {
        return array_find(self::List(), fn ($country) => strtoupper($country->name) === strtoupper($name));
    }
